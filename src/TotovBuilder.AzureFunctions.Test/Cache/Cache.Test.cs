...
namespace TotovBuilder.AzureFunctions.Test.Cache
{
    /// <summary>
    ...
    public class CacheTest
    {
        ...
        {
            // Arrange
            AzureFunctions.Cache.Cache cache = new AzureFunctions.Cache.Cache(
                new Mock<ILogger<AzureFunctions.Cache.Cache>>().Object,
